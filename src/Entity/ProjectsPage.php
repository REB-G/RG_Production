...
#[ORM\Entity(repositoryClass: ProjectsPageRepository::class)]
class ProjectsPage
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[Assert\NotBlank(message: 'Veuillez renseigner un titre pour la page réalisations.')]
    #[Assert\Length(
        min: 2, max: 255,
    ...
    #[Assert\NotBlank(message: 'Veuillez renseigner un texte pour la page réalisations.')]
    #[Assert\Length(
        min: 10, max: 1255,
